                ...
                <?php if ($model->admin_status == 4 && $model->return_status == 0) { ?>
                    ...
                    if ($diff < 14) {
                        ...
                        <li><a href="#returnModal" class="button-box order_return" id="<?= $model->order_id ?>" ordr="<?= yii::$app->EncryptDecrypt->Encrypt('encrypt', $model->order_id) ?>" data-toggle="modal">Return Order</a></li>
                                <!--<button type="button" class="track-btn order_return" id="<?= $model->order_id ?>" ordr="<?= yii::$app->EncryptDecrypt->Encrypt('encrypt', $model->order_id) ?>" data-toggle="modal" data-target="#returnModal"><i class="fa fa-ban" aria-hidden="true"></i>Return Order</button>-->
                                <!--<button class="track-btn remove_order" id="<?= $model->order_id ?>"><i class="fa fa-ban" aria-hidden="true"></i>Return Order</button>-->
                        <?php
                    }
                }
                ?>
            ...
            <div class="order-tracker-box">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        ...
                        <h4 class="text-box">Admin Canceled</h4>
                    </div>
                    <div class="col-xs-4">

                                        ...
                                        <tr>
                                            <td style="padding-bottom: 1em;">
                                                <p><strong>Dear <?= $user_detail->first_name . ' ' . $user_detail->last_name ?>, </strong><br><br>
                                                            <?php if ($status == 1) { ?>
                                                                Your Request for return is Approved.
                                                            <?php } else { ?>
                                                                Your Request for return is Disapproved.
                                                                            ...
                                                                            In the meantime, you can find some useful information by clicking on the below links: <br>
                                                                                ...
                                                                                <hr style="border: 1px solid #93c622;">
                                                                                    <div class="main-content" style="text-align:center;">
                                                                                        ...
                                                                                        <p style="margin-top:0px;margin-bottom: 0px;font-size: 15px;">Perfumeduniya Industry LLC, Dubai - 186887</p>
                                                                                    </div>
                                                                                    </td>
                                                                                    </tr>
                                                                                    </tbody>
